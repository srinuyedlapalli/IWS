...
public class EmailableReporter implements IReporter {
  ...
  public static String outputfilepath=GlobalFunctions.id()+"emailable-report.html";
  ...
  protected PrintWriter createWriter(String outdir) throws IOException {
    ...
    return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir,outputfilepath))));
